...
export default function Home() {
  return (
    <div className="bg-gray-100 text-gray-900">
      {/* Hero Section */}
      <section className="h-screen flex flex-col justify-center items-center text-center bg-cover bg-center relative" style={{ backgroundImage: "url('/hero.jpg')" }}>
        <div className="bg-black bg-opacity-50 absolute inset-0"></div>
        <div className="relative z-10">
          <h2 className="text-4xl font-bold text-white">Selamat Datang di Web Trans Madiun</h2>
          <p className="text-white mt-2">Transportasi Nyaman dan Terpercaya</p>
          <div className="mt-4">
            <Link href="#layanan" className="bg-white text-blue-600 px-6 py-2 rounded-md">Lihat Layanan</Link>
          </div>
        </div>
      </section>
      ...
      <section id="tentang" className="py-16 text-center bg-gray-200">
        ...
        <p className="max-w-3xl mx-auto text-gray-700">Kami menyediakan layanan transportasi terbaik dengan armada terbaru dan pengemudi profesional.</p>
      </section>
